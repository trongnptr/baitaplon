...
INSERT INTO `products_variants` (`product_variant_id`, `quantity`, `state`, `created_at`, `deleted_at`, `product_id`, `colour_id`, `size_id`) VALUES
...
INSERT INTO `orders` 
(`order_id`, `customer_name`, `email`, `phone_number`, `address`, `total_product_value`, `delivery_charges`, `total_order_value`, `user_id`) 
VALUES 
...
(`order_id`, `product_variant_id`, `order_item_index`, `price`, `quantity`, `total_value`) 
VALUES 
('71828451735555', 1, 1, 500000, 2, 1000000);


INSERT INTO `order_states` (`state_id`, `state_name`) VALUES (1, 'Processing');
...
INSERT INTO `order_status_change_histories` (`order_id`, `state_id`, `created_at`) 
VALUES ('71828451735555', 1, '2023-12-24 10:00:00');
