            ...
            <div className="container g-0">
                            ...
                            <div className='d-inline-block'>
                                <div className='contact-item d-flex align-items-center mb-4 mb-lg-2'>
                                    ...
                                    <div className='contact-content'>
                                        <span>Hotline</span>
                                        <p>0123456789 - <br />0123456789<br />(8:30-22:00)</p>
                                    </div>
                                </div>
                                <div className='contact-item d-flex align-items-center mb-4 mb-lg-2'>
                                    <div className='contact-icon d-inline-block'>
                ...
                <div className="footer-after row g-0 pt-3">
                    <div className="copyright col col-lg-8 pe-1">
                        <h5 className='copyright-title'>@ CÔNG TY TNHH MỘT MÌNH TÔI</h5>
                        <p className='copyright-description'>Mã số doanh nghiệp: 000000001. Giấy chứng nhận đăng ký doanh nghiệp do Sở Kế hoạch và Đầu tư TP Hà Nội cấp lần đầu ngày 2/2/2222.</p>
                    </div>
